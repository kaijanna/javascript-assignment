...
// ganske nice å lagre disse så de huskes på refersh OG er lett tilgjengelig
// er en funksjon og ikke en variabel fordi den kan endres
...
// sorterer, filterer og kaller på funksjon for å lage kortene i html
...
// denne lager select-elementet for å velge sjanger
...
// get movies and load filter and sort
async function getMovies() {
  try {
    ...
    // denne her lager bare en array med alle sjangrene (uten duplikater)
    const uniqueGenreArray = [...new Set(movies.map((movie) => movie.genre))];


    // Her legger jeg til en "Alle" i starten av arrayen som default-valg.
    ...
    // sortSelecten lagde jeg i html og legger bare på en eventlistener her
